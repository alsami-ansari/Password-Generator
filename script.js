class password {
  constructor() {
	...
	funnyPassword(){
		let arr= ["password","incorrect","12345678","iforgot","secret","MyPreciousssPasssword","MyName","Sami_Hacker","nothing","user","maiNahiBatunga","Sorry","1$perhour","admin","passwordIs1234", "ilovemygf", "rahabrBKL", "aveshPDF", "badmos"]
